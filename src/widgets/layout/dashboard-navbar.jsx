...
import { chevroncircleicon, notificationicon, profileavatar } from '@/assets';
          ...
          {shouldDisplaySearchBar && (
            <div className="mr-auto w-72 md:max-w-screen-3xl md:w-full rounded-md bg-white">
              <input
                type='search'
                placeholder="Search"
                className='p-3 w-full text-[#090909] font-light outline-none border border-[#DCDCDC] rounded-[6px]'
              />
            </div>
          )}
          {/* <div className="mr-auto w-72 md:max-w-screen-3xl md:w-full rounded-md bg-white">
